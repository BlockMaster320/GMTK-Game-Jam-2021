	...
	switch (room)
	{
		case rmLevel0:
		{
			...
			if (tutProgress >= 2)
			{
				...
				if (tutProgress == 2)
					draw_sprite_ext(sTutorial, 2, 360, 190, 0.8, 0.8, 0, c_white, tutOpacity);
				
				if (tutProgress == 3)
					draw_sprite_ext(sTutorial, 3, 360, 190, 0.8, 0.8, 0, c_white, tutOpacity);
				
				if (tutProgress == 4)
					draw_sprite_ext(sTutorial, 4, 360, 190, 0.8, 0.8, 0, c_white, tutOpacity);
